...
python test.py \
    ...
    --only_classifier --model_dir MGHCLD/runs/deberta-checkgpt_origin_v0 --detail_result_path MGHCLD/results/detail_result.csv --model_name models/deberta-v3-base`
...
python test.py \
    ...
    --model_dir MGHCLD/runs/deberta-checkgpt_origin_v0 \
    --detail_result_path MGHCLD/results/second_detail_result.csv --model_name models/deberta-v3-base`
