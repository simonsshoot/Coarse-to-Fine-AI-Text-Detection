...
def building(opt):
    ...
    result_df = text_df[text_df['id'].isin(selected_ids)]
...
if __name__ == '__main__':
  ...
  parser.add_argument('--text_file', type=str, default='MGHCLD/detect_data/checkgpt/test_id.csv', help='path to text file')
